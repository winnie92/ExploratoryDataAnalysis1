...
legend("topright",c("Sub_metering_1","Sub_metering_2","Sub_metering_3"),col=c("black","red","blue"),lty=1,y.intersp = 0.8,cex =0.5, adj =0.1)
par(new=F)
plot(da$date,da$Global_reactive_power,ylab="Global reactive power",xlab="datetime",type="l")
